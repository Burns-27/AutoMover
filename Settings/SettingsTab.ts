...
export class SettingsTab extends PluginSettingTab {
	...
	display = () => {
		...
		tutorialDetails.createEl("summary", {
			text: "Tutorial",
		...
		tutorialDetails.addEventListener("toggle", async () => {
			this.plugin.settings.collapseSections.tutorial =
				!tutorialDetails.open;
			await this.plugin.saveData(this.plugin.settings);
		});
		...
		CategorySection(containerEl, this.plugin, this.display);
	};
}
